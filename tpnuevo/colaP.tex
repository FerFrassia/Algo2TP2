...
\tadUsa{\tadNombre{Bool}, \tadNombre{Nat}, \tadNombre{Paquete}, \tadNombre{Secu($\alpha$)}}
...
\tadAxioma{suCamino($p_1$, encolar($p_2$, cp))}{\IF $p_1$ = $p_2$ THEN $\textless$$\textgreater$ ELSE suCamino(p, cp) FI}
\tadAxioma{suCamino($p_1$, agCompu($p_2$, c, cp))}{\IF $p_1$ = $p_2$ THEN suCamino(p, cp) $\circ$ c ELSE suCamino(p, cp) FI}
...
\begin{Interfaz}
  ...
  \InterfazFuncion{Vacío}{}{colaP(Paquete)}
  %[ACA VA EL PRE (SI LO HUBIERA)]
  {$res \igobs$ vacio()}
  [$\Complejidad{1}$]
  [Crea una nueva cola.]
	
  \InterfazFuncion{Agregar}{\Inout{c}{colaP(Paquete)}, \In{a}{nat}, \In{b}{nat}}{}
  [$c_t \igobs c$]
  ...
  [Revisa si la cola contiene por lo menos algun elemento.]
	...
	\InterfazFuncion{Desencolar}{\Inout{c}{colaP(Paquete)}}{tupla(a: nat, b: nat)}
  [$c \igobs c_t \wedge \neg$(vacia?(c))]
  {$res \igobs$ proximo(c\_t) $\wedge\ c \igobs$ desencolar(c\_t)}
  [$\Complejidad{log_2\ N}$ con $N$ siendo la cantidad total de elementos en la cola.]
  [Devuelve la tupla de numeros mas grande y la quita de la cola.]
	
	\InterfazFuncion{Tamaño}{\Inout{c}{colaP(Paquete)}}{nat}
  %[$c \igobs c_t \wedge \neg$(vacia?(c))]
  {$res \igobs$ tamaño(c)}
  [$\Complejidad{1}$]
  [Devuelve la cantidad total de elementos.]
	
	\InterfazFuncion{Eliminar}{\Inout{c}{colaP(Paquete)}, \In{a}{nat}, \In{b}{nat}}{}
  [c = c0]
  {$c \igobs$ borrar(c0, k)}
  [$\Complejidad{log_2\ N}$ con $N$ siendo la cantidad total de elementos en la cola.]
...
\begin{Estructura}{colaP(Paquete)}[e\_cola]
	\begin{Tupla}[e\_cola]
...
\Algoritmo{IVacio}{}{colaP(Paquete)}{
	\State var res: colaP(Paquete) $\gets$ tupla(NULL, 0) \ComplejidadDer{1}
	}{\Complejidad{1}}{}

\Algoritmo{IAgregar}{\Inout{c}{colaP(Paquete)}, \In{a}{nat}, \In{b}{nat}}{}{
	\If{c.raiz $==$ NULL}
