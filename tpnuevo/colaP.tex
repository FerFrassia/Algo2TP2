...
\tadExporta{col·Pr, generadores, observadores}
...
\begin{Interfaz}
  ...
  \textbf{gÈneros}: \TipoVariable{colaP}.

  \Titulo{Operaciones b·sicas de RestricciÛn}

  \InterfazFuncion{VacÌo}{}{colaP}
  ...
  [Devuelve la tupla de numeros mas grande y la quita de la cola.]
	...
	\InterfazFuncion{TamaÒo}{\Inout{c}{colaP}}{nat}
  %[$c \igobs c_t \wedge \neg$(vacia?(c))]
  {$res \igobs$ tamaÒo(c)}
  [$\Complejidad{1}$]
...
\Algoritmo{ITamaÒo}{\Inout{c}{colaP}}{nat}{
