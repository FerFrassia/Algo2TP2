...
\begin{Interfaz}
 ...
 [Calcula y devuelve el factor de desbalance actual de p]
  ...
  \InterfazFuncion{Siguientes}{\In{it}{itClave}}{Lista Enlazada}
  [true]
...
\Algoritmo{IAvanzar}{\Inout{it}{itClave}}{}{
	...
	\State it.nodoActual $\gets$ \NombreFuncion{Siguiente}(\NombreFuncion{crearIt}(DameNodos(it.raiz, 1, it.nivelActual))) \ComplejidadDer{n}
	\EndIf
...
\Algoritmo{ISiguientes}{\In{it}{itClave}}{Lista Enlazada}{
