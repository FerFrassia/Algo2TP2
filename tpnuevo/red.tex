...
\subsection{Auxiliares}
  ...
  \InterfazFuncion{CaminosMinimos}{\In{r}{red}, \In{c_1}{compu}, \In{c_2}{compu}}{conj(lista)}
  [\{$c_1,c_2$\} $\subseteq$ computadoras($r$)]
  {$res$ $\igobs$ caminosMinimos(r, $c_1$, $c_2$)}
  [$\Complejidad{ALGO}$]
...
\begin{Algoritmos}
	...
	\begin{Algoritmo}{iAgregarComputadora}{\Inout{r}{red}, \In{c}{compu}}{}
	{
		...
		\State Definir($r.vecinosEInterfaces$, $c.ip$, tupla(Vacío(), Vacio())) \ComplejidadDer{|c|}
	...
	\begin{Algoritmo}{iConectar}{\Inout{r}{red}, \In{c_1}{compu}, \In{i_1}{interfaz}, \In{c_2}{compu}, \In{i_2}{interfaz}}{}
	{
		...
		\State Definir(Significado($r.deOrigenADestino$, $c_1.ip$), $c_2.ip$, ArmarCaminosMinimos($r, c_1, c_2$)) \ComplejidadDer{1}
		%Guardo los caminos minimos de c_2 a c_1
		\State Definir(Significado($r.deOrigenADestino$, $c_2.ip$), $c_1.ip$, ArmarCaminosMinimos($r, c_2, c_1$)) \ComplejidadDer{1}		
	}
	{$\Complejidad{|e_1| + |e_2|}$}
	...
	\begin{Algoritmo}{iArmarCaminos}{\In{r}{red}, \In{c_1}{compu}, \In{c_2}{compu}}{conj(lista)}
	{
		\State var $pacial$:lista $\gets$ Vacia() \ComplejidadDer{1}
		\State AgregarAtras($parcial$, $c_1$) \ComplejidadDer{1}
		\State $res$ $\gets$ \NombreFuncion{TodosLosCaminos}($r$, $c_1$, $c_2$, $parcial$) \ComplejidadDer{1}
	}
	{}
	{}
	\end{Algoritmo}
	
	\begin{Algoritmo}{iTodosLosCaminos}{\In{r}{red}, \In{c_1}{compu}, \In{c_2}{compu}, \In{pacial}{lista(compu)}}{conj(lista)}
	{
		...
		\Else
			...
			\While{HaySiguiente?($itVecinos$)} \ComplejidadDer{1}
				\If {$¬$Pertenece?($parcial$, Siguiente($itVecinos$))} \ComplejidadDer{1}
					...
					\State Unir($res$, TodosLosCaminos($r$, Siguiente($itVecinos$), $c_2$, $auxParcial$)) \ComplejidadDer{1}
				\EndIf	
